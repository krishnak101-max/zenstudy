    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh]">
        <div className="relative w-24 h-24 mb-6">
          ...
          <div className="relative w-full h-full bg-gradient-to-br from-indigo-500 to-purple-600 rounded-[2rem] flex items-center justify-center text-4xl shadow-xl shadow-indigo-500/30">🦅</div>
        </div>
        <p className="text-[10px] font-black text-indigo-200 uppercase tracking-[0.4em] animate-pulse">Synchronizing Presence...</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 pt-12 text-white">
      <div className="flex justify-between items-start mb-10">
        <div>
          <p className="text-[10px] font-black text-indigo-300 uppercase tracking-widest mb-1.5">Wings Seeker</p>
          <h1 className="text-3xl font-black text-white tracking-tight leading-none">{student?.name}</h1>
          <p className="text-[11px] font-bold text-indigo-200 mt-2 uppercase tracking-widest bg-white/10 inline-block px-2 py-1 rounded-lg border border-white/10">{student?.batch} Batch</p>
        </div>
        <div className={`${medalClass} text-white px-5 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-2xl flex flex-col items-center justify-center min-w-[110px] transition-all transform hover:scale-105 active:scale-95 cursor-default border border-white/20`}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-10">
        <div className="bg-white/5 backdrop-blur-md p-6 rounded-[2.5rem] shadow-2xl relative overflow-hidden group border border-white/10 transition-all hover:bg-white/10">
          ...
          <p className="text-[9px] text-indigo-200 font-black uppercase tracking-widest mb-2">Power Points</p>
          <p className="text-4xl font-black text-white tracking-tighter">{stats?.total_points || 0}</p>
        </div>
        <div className="bg-white/5 backdrop-blur-md p-6 rounded-[2.5rem] shadow-2xl relative overflow-hidden group border border-white/10 transition-all hover:bg-white/10">
          <div className="absolute -right-4 -bottom-4 text-7xl opacity-[0.1] rotate-12 group-hover:rotate-0 transition-transform duration-700 grayscale hover:grayscale-0">🔥</div>
          <p className="text-[9px] text-indigo-200 font-black uppercase tracking-widest mb-2">Consistency</p>
          <p className="text-4xl font-black text-white tracking-tighter">{stats?.current_streak || 0} <span className="text-[10px] text-indigo-400 font-black uppercase ml-1">Days</span></p>
        </div>
      </div>
        ...
        {!todayAttendance ? (
          <div className="space-y-6">
            <button
              ...
              className="w-full bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white h-60 rounded-[3.5rem] shadow-2xl shadow-indigo-900/50 flex flex-col items-center justify-center transition-all active:scale-[0.96] group relative overflow-hidden border border-white/20 hover:shadow-indigo-500/50 duration-500"
            >
            ...
            <div className="flex items-center justify-center space-x-2 text-[10px] font-black text-indigo-300 uppercase tracking-widest opacity-60">
              <span className="w-8 h-[1px] bg-indigo-300/30"></span>
          ...
          <div className="space-y-5">
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[3.5rem] p-10 text-center relative overflow-hidden shadow-2xl">
              ...
              <div className="mb-8">
                <p className="text-indigo-200 font-black bg-white/10 py-2 px-5 rounded-full inline-block text-[10px] uppercase tracking-widest border border-white/10 shadow-sm">
              ...
              {todayAttendance.rank_today <= 5 && (
                <div className="mb-8 animate-bounce">
                  ...
                  <p className="text-[8px] text-indigo-200 font-medium uppercase tracking-widest mt-1">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-black/20 rounded-3xl p-6 shadow-inner border border-white/5">
                  <p className="text-[10px] text-indigo-300 font-black uppercase tracking-widest mb-1.5">Energy</p>
                  <p className="text-2xl font-black text-white">+{todayAttendance.points}</p>
                </div>
                <div className="bg-black/20 rounded-3xl p-6 shadow-inner border border-white/5">
                  <p className="text-[10px] text-indigo-300 font-black uppercase tracking-widest mb-1.5">Time</p>
            ...
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-3xl p-7 text-center shadow-lg relative group overflow-hidden backdrop-blur-md">
      ...
      <div className="bg-white/5 backdrop-blur-xl p-8 rounded-[3rem] shadow-lg border border-white/10 mb-6">
        <div className="flex justify-between items-center mb-8">
          <h3 className="font-black text-white text-[11px] uppercase tracking-widest">Ascension path</h3>
          <span className="text-[10px] font-black text-indigo-200 uppercase tracking-widest bg-white/10 px-2 py-0.5 rounded-lg border border-white/10">Best: {stats?.best_streak || 0}D</span>
        </div>
        <div className="flex justify-between relative px-2">
          ...
          <div
            className="absolute top-7 left-0 h-1.5 zen-gradient -z-0 transition-all duration-1000 rounded-full mx-6 shadow-[0_0_15px_rgba(99,102,241,0.5)]"
            style={{ width: `calc(${Math.min(100, (stats?.current_streak || 0) / 30 * 100)}% - 48px)` }}
          ></div>
        </div>
        <p className="mt-10 text-center text-[9px] font-black text-indigo-400/50 uppercase tracking-[0.3em] italic">Consistency is the fuel of ZenStudy</p>
      </div>
    </div>
  );
};
